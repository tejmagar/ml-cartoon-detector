...
train_dataset = train.flow_from_directory('train/', target_size=(200, 200), batch_size=8, class_mode='binary')
print(train_dataset.classes)

validation_dataset = train.flow_from_directory('validation/', target_size=(200, 200), batch_size=8, class_mode='binary')
print(train_dataset.classes)
